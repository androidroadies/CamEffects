...
public class ActivityOptionsIntents extends Activity {
	Context context;
...
//				startActivity(intent);
	...
	private void addTextHere() {
		...
		LayoutInflater layoutInflater = LayoutInflater
				.from(ActivityOptionsIntents.this);
		View addTextView = layoutInflater.inflate(
				R.layout.add_text_here_dialog, null);
		AlertDialog.Builder alertDialog = new AlertDialog.Builder(
				ActivityOptionsIntents.this);
		alertDialog.setView(addTextView);
		etTextHere = (EditText) addTextView
				.findViewById(R.id.input_top_up_value);
